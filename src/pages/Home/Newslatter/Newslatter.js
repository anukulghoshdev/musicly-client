...
import nl from './../../../assests/nl.jpg'

const Newslatter = () => {
    return ( //style={{backgroundImage: `url(${nl})`}}

        <div className="bg-center bg-cover bg-indigo-500">
            

            <section className=" max-w-xl py-7  mx-auto px-4 pb-16 z-10">
                <div className="space-y-4 text-center">
                    ...
                    <h1 className="text-3xl text-gray-100 font-semibold z-10">
