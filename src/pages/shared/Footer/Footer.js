...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-slate-200 border-2 border-gray-200">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link rel="noopener noreferrer" to="/" className="flex justify-center space-x-3 lg:justify-start">
                            <img className='w-4 mr-0' src={icon} alt="" />
                            <span className="self-center text-2xl font-semibold">Musicly</span>
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase text-neutral font-semibold">Product</h3>
                        ...
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase text-neutral font-semibold">Company</h3>
                            <ul className="space-y-1">
                                <li>
                        ...
                        <div className="space-y-3">
                            <h3 className="uppercase text-neutral font-semibold">Developers</h3>
                            <ul className="space-y-1">
                                <li>
                        ...
                        <div className="space-y-3">
                            <div className="uppercase text-neutral font-semibold">Social media</div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">© 2022 Musicly Co. All rights reserved.</div>
            </footer>
        </div>
    );
};
