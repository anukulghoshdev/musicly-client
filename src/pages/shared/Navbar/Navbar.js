    ...
    return (
        <div className="navbar bg-base-100 px-2 lg:px-10">
            ...
            <div className="navbar-end">
                ...
                {
                    user?.uid ?
                        <button onClick={handleLogout} class="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-indigo-600 border-2 border-indigo-600 rounded-full hover:text-white group hover:bg-gray-50">
